...
const COMICS = [
  {
    ...
    episodes: [
      ...
      { n: 2, title: "The Frying Pan of Destiny", date: "Sep 12, 2026", image: "assets/images/episodes/pixel-quest-e2.jpg", available: true },
      { n: 3, title: "Boss Fight (Mostly Running)", date: "Sep 19, 2026", image: "assets/images/episodes/pixel-quest-e3.jpg", available: true }
    ]
  },
  {
    id: "midnight-diner",
    ...
    episodes: [
      ...
      { n: 2, title: "Coffee for a Ghost", date: "Sep 11, 2026", image: "assets/images/episodes/midnight-diner-e2.jpg", available: true },
      { n: 3, title: "The Man Who Ordered Yesterday", date: "Sep 18, 2026", image: "assets/images/episodes/midnight-diner-e3.jpg", available: true }
    ]
  },
  {
    id: "star-hoppers",
    ...
    episodes: [
      ...
      { n: 2, title: "The Duck Nebula", date: "Sep 9, 2026", image: "assets/images/episodes/star-hoppers-e2.jpg", available: true },
      { n: 3, title: "Return to Sender: A Black Hole", date: "Sep 16, 2026", image: "assets/images/episodes/star-hoppers-e3.jpg", available: true }
    ]
  },
  {
    id: "last-librarian",
    ...
    episodes: [
      ...
      { n: 2, title: "The Forbidden Page", date: "Aug 27, 2026", image: "assets/images/episodes/last-librarian-e2.jpg", available: true },
      { n: 3, title: "What Stories Cost", date: "Sep 3, 2026", image: "assets/images/episodes/last-librarian-e3.jpg", available: true }
    ]
  },
  {
    id: "ghost-roommates",
    ...
    episodes: [
      ...
      { n: 2, title: "Who Ate My Leftovers? (It Was Sir Reginald)", date: "Sep 6, 2026", image: "assets/images/episodes/ghost-roommates-e2.svg", available: true },
      { n: 3, title: "Séance Movie Night", date: "Sep 13, 2026", image: "assets/images/episodes/ghost-roommates-e3.svg", available: true }
    ]
  },
  {
    id: "ink-ember",
    ...
    episodes: [
      ...
      { n: 2, title: "The Price of Fire", date: "Sep 4, 2026", image: "assets/images/episodes/ink-ember-e2.svg", available: true },
      { n: 3, title: "A Stranger's Design", date: "Sep 11, 2026", image: "assets/images/episodes/ink-ember-e3.svg", available: true }
    ]
  }
];
